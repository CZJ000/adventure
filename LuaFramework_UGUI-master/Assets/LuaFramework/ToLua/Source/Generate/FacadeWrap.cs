...
public class FacadeWrap
{
	...
	static int RegisterCommand(IntPtr L)
	{
		try
		{
			...
			Facade obj = (Facade)ToLua.CheckObject<Facade>(L, 1);
	...
	static int SendMessageCommand(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Facade.SendMessageCommand");
			}
		}
		catch (Exception e)
		{
